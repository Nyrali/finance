...
def generate_resizable_stacked_chart_html(
    df, categories, output_file="D:/finance/resizable_stacked_chart.html"
):
    import pandas as pd
...
def patron_generate_resizable_stacked_chart_html_1(
    df, categories, output_file="D:/finance/patron_chart_1.html", opacity=0.90
):
    try:
