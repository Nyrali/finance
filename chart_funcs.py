...
def assemble_chart_html_from_parts(
    ...
    script = (
        script_template
        .replace("__TRANSACTIONS__", json.dumps(transactions_json, ensure_ascii=False))
...
def generate_chart_with_templates(df, categories, output_file="D:/finance/chart_from_templates.html", opacity=0.90):
    try:
