...
def sort_categories(pivoted):
    base_order = [
        "bydlení", "zdraví a pojištění", "restaurace / fast food", "potraviny (supermarket)", "doprava",
        "zábava a volný čas", "oblečení a styl", "ostatní nákupy", "jiné finanční výdaje"
    ]
...
def generate_resizable_stacked_chart_html_1(df, categories, output_file="D:/finance/chart_1.html", opacity=0.90):
    try:        
